...
but =Button(text="Ввести", font=("Arial", 16), width=10, height=1, command=lambda: funcs.print_text(text2, entry.get()))
but.place(anchor="center", relx=0.5,rely=0.4)

but2 =Button(text="Поменять цвет", font=("Arial", 16))
but2.place(anchor="center", relx=0.5,rely=0.5)
